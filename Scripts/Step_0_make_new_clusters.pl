...
my $path_to_formatdb = "/usr/local/bin/formatdb";
my $path_to_blastall = "/usr/local/bin/blastall";
my $path_to_muscle   = "/usr/local/bin/muscle";
my $path_to_hmmbuild = "/usr/local/bin/hmmbuild";
my $path_to_hmmpress = "/usr/local/bin/hmmpress";
